        ...
        <>
            <div className='lg:-ml-24'>
                ...
                <div className='relative'>
                    <div className='flex flex-col w-[78vw] items-center relative blur lg:-ml-1 -ml-4'>
                    ...
                    <div className='absolute w-[34vw] lg:w-[30vw] h-[17.4vw] lg:h-[15vw] bg-blue-600 flex lg:top-[5vw] lg:left-[38vw] top-[8vw] left-[35vw] lg:pt-14 pl-12 pd-4 pt-10  flex-col ' style={{ clipPath: "polygon(0% 15%, 85% 0%, 100% 100%, 0% 100%)" }}>
